        ...
        function e() {
            ...
            if (!("scrollBehavior" in t.documentElement.style) || !0 === e.__forceSmoothScrollPolyfill__) {
                ...
                e.scroll = e.scrollTo = function() {
                    ...
                    void 0 !== arguments[0] && (d(arguments[0]) ? a.scrollBy.call(e, void 0 !== arguments[0].left ? arguments[0].left : "object" != typeof arguments[0] ? arguments[0] : 0, void 0 !== arguments[0].top ? arguments[0].top : void 0 !== arguments[1] ? arguments[1] : 0) : g.call(e, t.body, ~~arguments[0].left + (e.scrollX || e.pageXOffset), ~~arguments[0].top + (e.scrollY || e.pageYOffset)))
                    ...
                    if (!0 !== d(arguments[0])) {
                        var o = function(e) {
                                for (; e !== t.body && !1 === (n = c(o = e, "Y") && u(o, "Y"), i = c(o, "X") && u(o, "X"), n || i);) e = e.parentNode || e.host;
                                var o, n, i;
                                return e
                            }(this),
            ...
            function f(t) {
                var o, n, a, l, s = (r() - t.startTime) / i;
                l = s = s > 1 ? 1 : s, o = .5 * (1 - Math.cos(Math.PI * l)), n = t.startX + (t.x - t.startX) * o, a = t.startY + (t.y - t.startY) * o, t.method.call(t.scrollable, n, a), n === t.x && a === t.y || e.requestAnimationFrame(f.bind(e, t))
            }

            function g(o, n, i) {
                var l, d, c, u, g = r();
                o === t.body ? (l = e, d = e.scrollX || e.pageXOffset, c = e.scrollY || e.pageYOffset, u = a.scroll) : (l = o, d = o.scrollLeft, c = o.scrollTop, u = s), f({
                    scrollable: l,
                    method: u,
                    startTime: g,
                    startX: d,
    ...
    function() {
        ...
        window.kadence = {
                ...
                if (t.length)
                    for (let i = 0; i < t.length; i++) {
                        ...
                        if (o.querySelector(".dropdown-nav-toggle")) {
                            ...
                            n.setAttribute("aria-label", kadenceConfig.screenReader.expand), n.classList.add("dropdown-nav-special-toggle"), o.insertBefore(n, o.childNodes[1]), n.addEventListener("click", (function(e) {
                                e.preventDefault(), window.kadence.toggleSubMenu(e.target.parentNode)
                                ...
                                9 === e.keyCode && (e.shiftKey ? window.kadence.isfirstFocusableElement(t[i], document.activeElement, o) && window.kadence.toggleSubMenu(t[i].parentNode, !1) : window.kadence.islastFocusableElement(t[i], document.activeElement, o) && window.kadence.toggleSubMenu(t[i].parentNode, !1))
            ...
            toggleDrawer: function(e, t) {
                ...
                if (window.kadence.toggleAttribute(o, "aria-expanded", "true", "false"), n.classList.contains("show-drawer")) o.dataset.toggleBodyClass && i.body.classList.remove(o.dataset.toggleBodyClass), n.classList.remove("active"), n.classList.remove("pop-animated"), i.body.classList.remove("kadence-scrollbar-fixer"), setTimeout((function() {
                    ...
                    document.addEventListener("keydown", (function(e) {
                        ("Tab" === e.key || 9 === e.keyCode) && (e.shiftKey ? document.activeElement === s && (d.focus(), e.preventDefault()) : document.activeElement === d && (s.focus(), e.preventDefault()))
                    }))
                }
            },
            ...
            initStickyHeader: function() {
                var e = document.querySelector("#main-header .kadence-sticky-header"),
                    ...
                    r = 0,
                    l = 0;
                parseInt(kadenceConfig.breakPoints.desktop) < window.innerWidth ? (a = "desktop", e && (e.style.position = "static", l = window.kadence.getOffset(e).top, e.style.position = null)) : t && (t.style.position = "static", l = window.kadence.getOffset(t).top, t.style.position = null);
                var s, d, c, u = function(s) {
                    var d, c = window.kadence.getOffset(o).top;
                    ...
                    if (d = kadenceConfig.breakPoints.desktop <= window.innerWidth ? e : t) {
                        kadenceConfig.breakPoints.desktop <= window.innerWidth ? "mobile" === a ? (l = window.kadence.getOffset(d).top, a = "desktop") : s && "updateActive" === s && (d.style.top = "auto", l = window.kadence.getOffset(d).top, a = "desktop") : "desktop" === a ? (l = window.kadence.getOffset(d).top, a = "mobile") : s && "updateActive" === s && (d.style.top = "auto", l = window.kadence.getOffset(d).top, a = "mobile");
                        var h = d.parentNode,
                            w = d.getAttribute("data-shrink"),
                            m = d.getAttribute("data-reveal-scroll-up"),
                            p = parseInt(d.getAttribute("data-start-height"));
                        if ((!p || s && void 0 !== s.type && "orientationchange" === s.type) && (d.setAttribute("data-start-height", d.offsetHeight), p = d.offsetHeight, h.classList.contains("site-header-upper-inner-wrap") ? (h.style.height = null, s && void 0 !== s.type && "orientationchange" === s.type ? d.classList.contains("item-is-fixed") ? setTimeout((function() {
                                h.style.height = Math.floor(h.offsetHeight + d.offsetHeight) + "px"
                            }), 21) : setTimeout((function() {
                                h.style.height = h.offsetHeight + "px"
                            }), 21) : h.style.height = h.offsetHeight + "px") : h.classList.contains("site-header-inner-wrap") ? (h.style.height = null, h.style.height = h.offsetHeight + "px") : h.style.height = d.offsetHeight + "px"), "true" === w) {
                            var v = d.getAttribute("data-shrink-height");
                            if (v) {
                                if ("true" === m)
                                    if (window.scrollY > r) var y = Math.floor(Math.floor(l) - Math.floor(c) + Math.floor(p));
                                ...
                                if (S || (L.setAttribute("data-start-height", L.offsetHeight), S = L.offsetHeight), window.scrollY <= y) L.style.height = S + "px", L.style.minHeight = S + "px", L.style.maxHeight = S + "px", b && (b.style.maxHeight = "100%"), k && (k.style.maxHeight = "100%");
                        ...
                        if ("true" === m) {
                            ...
                            else if (O) d.classList.add("item-hidden-above"), d.style.transform = "translateY(" + (Math.abs(H) > A ? -A : H) + "px)";
                            else {
                                E = Math.floor(l - c);
                ...
                if ((e || t) && (window.addEventListener("resize", u, !1), window.addEventListener("scroll", u, !1), window.addEventListener("load", u, !1), window.addEventListener("orientationchange", u), "complete" === document.readyState && u("updateActive"), document.body.classList.contains("woocommerce-demo-store") && document.body.classList.contains("kadence-store-notice-placement-above"))) {
                    s = document.querySelector(".woocommerce-store-notice"), d = e => {
                        u("updateActive")
                    }, c = {
